...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _model_Search_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model/Search.js */ \"./model/Search.js\");\n/* harmony import */ var _model_Recipe_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./model/Recipe.js */ \"./model/Recipe.js\");\n/* harmony import */ var _model_Likes_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./model/Likes.js */ \"./model/Likes.js\");\n/* harmony import */ var _views_searchView__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/searchView */ \"./views/searchView.js\");\n/* harmony import */ var _views_recipeView__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./views/recipeView */ \"./views/recipeView.js\");\n/* harmony import */ var _views_likesView__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./views/likesView */ \"./views/likesView.js\");\n/* harmony import */ var _views_base__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./views/base */ \"./views/base.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nconst state = {};\r\n\r\n\r\nconst controlSearch = async () => {\r\n  // 1) Get query from the view\r\n  console.log(\"in search controller\");\r\n  const query ='pizza';\r\n  $(\".recipeList\").empty(); \r\n\r\n  if (query) {\r\n    // 2) New Search Object and add to state\r\n    state.search = new _model_Search_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](query);\r\n\r\n    //3) Prepare UI for results\r\n\r\n      // 4) Search for recipes\r\n      await state.search.getResults();\r\n      var e= state.search.result.recipes;\r\n      const p1 = new _views_searchView__WEBPACK_IMPORTED_MODULE_3__[\"Pagination\"](state.search.result.recipes, 5);\r\n      var x=1;\r\n      var p='';\r\n      var v=-0;\r\n      var numOfpages=_views_searchView__WEBPACK_IMPORTED_MODULE_3__[\"renderPages\"](state.search.result.recipes);\r\n      p1.display(1).forEach(_views_searchView__WEBPACK_IMPORTED_MODULE_3__[\"renderRecipe\"]);\r\n      while (numOfpages>=x){\r\n          p+=`<li value=\"${v}\" class=\"pa\"> ${x}</li>`;\r\n          v+=1;\r\n          x+=1;\r\n      }\r\n\r\n    $( `${p}` ).insertBefore(\".pagination\" );\r\n    var nodes=document.getElementsByClassName(\"pa\");\r\n    for (var i = 0; i < nodes.length; i++) {\r\n      nodes[i].addEventListener (\"click\", (e) => {\r\n        $(\".recipeList\").empty();\r\n        p1.display(e.target.value+1).forEach(_views_searchView__WEBPACK_IMPORTED_MODULE_3__[\"renderRecipe\"]);\r\n\r\n\r\n    })\r\n    }  \r\n  }\r\n};\r\n\r\n_views_base__WEBPACK_IMPORTED_MODULE_6__[\"elements\"].searchForm.addEventListener(\"submit\", e => {\r\n    console.log(\"listening\");\r\n    $(\".pa\").empty();\r\n    controlSearch();\r\n    e.preventDefault();\r\n});\r\n\r\nconsole.log('hi');\r\n\r\nconst recipeController = async () => {\r\n  console.log(\"Entered Controller\");\r\n\r\n  var recipe_id = window.location.hash.replace('#', '');\r\n  // console.log(uri);\r\n  // const recipe_title = decodeURI(uri);\r\n  // console.log(recipe_title);\r\n  if (recipe_id) {\r\n  // // console.log(\"if\");\r\n     \r\n    state.recipe = new _model_Recipe_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"](recipe_id);\r\n  // // console.log(state.recipe);\r\n\r\n    try {\r\n         await state.recipe.getRecipe(recipe_id);\r\n         console.log(state.recipe);\r\n         _views_recipeView__WEBPACK_IMPORTED_MODULE_4__[\"displayRecipe\"](state.recipe);\r\n    }\r\n\r\n    catch(error) {\r\n      alert(\"There was an error loading the recipe\");\r\n    }\r\n  }\r\n};\r\n\r\nwindow.addEventListener('hashchange', e => {\r\n  recipeController();\r\n});\r\n\r\n\r\nconst likeController = () => {\r\n\tconsole.log(\"Entered like controller\");\r\n\tif (!state.likes) {\r\n\t\tstate.likes = new _model_Likes_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\r\n\t}\r\n\r\n\tconst current = state.recipe.id;\r\n  \tconst c = state.likes.liked(current);\r\n  \tconsole.log(state.likes.liked(current));\r\n\r\n\tif (!state.likes.liked(current)) {\r\n\t\t// console.log('hello');\r\n\t\tstate.likes.delLike(current);\r\n\t\t_views_likesView__WEBPACK_IMPORTED_MODULE_5__[\"removeLike\"](current);\r\n\r\n\t}\r\n\r\n\telse {\r\n\t\tconst title = state.recipe.title;\r\n\t\tconst publisher = state.recipe.publisher;\r\n\t\tconst image = state.recipe.image;\r\n\r\n\t\tconst newLike = state.likes.addLike(current, title, publisher, image);\r\n\t\t// console.log(newLike);\r\n\t\t_views_likesView__WEBPACK_IMPORTED_MODULE_5__[\"likeDisplay\"](newLike);\r\n\t}\r\n\r\n};\r\n\r\n_views_base__WEBPACK_IMPORTED_MODULE_6__[\"elements\"].recipe.addEventListener('click', e =>{\r\n\tconsole.log(\"entered event listener\");\r\n\tif (e.target.matches('.fa-heart')) {\r\n\t\tlikeController();\r\n\t\t// console.log(\"ha\");\r\n\t}\t\r\n});\r\n\r\nwindow.addEventListener('load', () => {\r\n\tstate.likes = new _model_Likes_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\r\n\t// console.log(\"before\");\r\n\t// console.log(state.likes);\r\n\tstate.likes.reload();\r\n\tconsole.log(\"after\");\r\n\tstate.likes.likes.forEach(like => _views_likesView__WEBPACK_IMPORTED_MODULE_5__[\"likeDisplay\"](like));\r\n});\r\n\n\n//# sourceURL=webpack:///./index.js?");
...
/*!****************************!*\
  !*** ./views/likesView.js ***!
  \****************************/
/*! exports provided: likeDisplay, removeLike */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"likeDisplay\", function() { return likeDisplay; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"removeLike\", function() { return removeLike; });\n/* harmony import */ var _base__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./base */ \"./views/base.js\");\n\r\n\r\nconst likeDisplay = like => {\r\n    if (like != undefined) {\r\n        const m = `\r\n            <li>\r\n                <a class=\"likes__link\" href=\"#${like.id}\">\r\n                    <div class=\"likes__image\">\r\n                        <img src=\"${like.image}\" alt=\"${like.title}\" class =\"liked_image\">\r\n                    <div class=\"likes__data\">\r\n                        <h6 class=\"likes__name\">${like.title}</h6>\r\n                        <p class=\"likes__author\">${like.publisher}</p>\r\n                    </div>\r\n                </a>\r\n            </li>\r\n        `;\r\n        _base__WEBPACK_IMPORTED_MODULE_0__[\"elements\"].likesList.insertAdjacentHTML('beforeend', m);\r\n    }\r\n};\r\n\r\nconst removeLike = id => {\r\n    const e = document.querySelector(`.likes__link[href*=\"${id}\"]`).parentElement;\r\n    if (e) e.parentElement.removeChild(e);\r\n};\n\n//# sourceURL=webpack:///./views/likesView.js?");
