...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _model_Search_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model/Search.js */ \"./model/Search.js\");\n/* harmony import */ var _views_searchView__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./views/searchView */ \"./views/searchView.js\");\n/* harmony import */ var _views_recipeView__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./views/recipeView */ \"./views/recipeView.js\");\n/* harmony import */ var _views_base__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/base */ \"./views/base.js\");\n\r\n\r\n\r\n\r\nconst state = {};\r\n\r\n\r\nconst controlSearch = async () => {\r\n  // 1) Get query from the view\r\n  const query ='pizza';\r\n  $(\".recipeList\").empty(); \r\n\r\n  if (query) {\r\n    // 2) New Search Object and add to state\r\n    state.search = new _model_Search_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](query);\r\n\r\n    //3) Prepare UI for results\r\n\r\n      // 4) Search for recipes\r\n      await state.search.getResults();\r\n      var e= state.search.result.recipes;\r\n      const p1 = new _views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"Pagination\"](state.search.result.recipes, 5);\r\n      var x=1;\r\n      var p='';\r\n      var v=-0;\r\n      var numOfpages=_views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"renderPages\"](state.search.result.recipes);\r\n      p1.display(1).forEach(_views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"renderRecipe\"]);\r\n      while (numOfpages>=x){\r\n          p+=`<li value=\"${v}\" class=\"pa\"> ${x}</li>`;\r\n          v+=1;\r\n          x+=1;\r\n      }\r\n\r\n    $( `${p}` ).insertBefore(\".pagination\" );\r\n    var nodes=document.getElementsByClassName(\"pa\");\r\n    for (var i = 0; i < nodes.length; i++) {\r\n      nodes[i].addEventListener (\"click\", (e) => {\r\n        $(\".recipeList\").empty();\r\n        p1.display(e.target.value+1).forEach(_views_searchView__WEBPACK_IMPORTED_MODULE_1__[\"renderRecipe\"]);\r\n\r\n\r\n    })\r\n    }  \r\n  }\r\n};\r\n\r\n_views_base__WEBPACK_IMPORTED_MODULE_3__[\"elements\"].searchForm.addEventListener(\"submit\", e => {\r\n$(\".pa\").empty();\r\n  controlSearch();\r\n  e.preventDefault();\r\n});\r\nconsole.log('hi');\r\n\n\n//# sourceURL=webpack:///./index.js?");
...
/*!*****************************!*\
  !*** ./views/recipeView.js ***!
  \*****************************/
/*! exports provided: viewRecipe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"viewRecipe\", function() { return viewRecipe; });\nconst viewRecipe= (j) => {\r\n\tconsole.log(j);\r\n}\n\n//# sourceURL=webpack:///./views/recipeView.js?");
